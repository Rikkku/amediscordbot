...
module.exports = {
	...
	category: "Music",
	aliases: ["leave", "break", "destroy", "dis", "disconnect" ,"fuckoff"],
	usage: "stop",
		...
		try {
			...
			try {
				...
				if (!newQueue || !newQueue.songs || newQueue.songs.length == 0) return message.reply({
					embeds: [
						new MessageEmbed().setColor(ee.wrongcolor).setTitle(`${client.allEmojis.x} **I am not Playing anything right now!**`)
					],
				})
